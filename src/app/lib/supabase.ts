...
export const PERMISSION_GROUPS: { label: string; items: { key: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // 0437: its own key, not payroll.edit. Raising an adjustment is correcting
      // a disbursement after the fact, and it should be grantable to someone who
      // cannot run payroll. Mirrored in public.permission_keys.
      { key: "payroll.adjust", label: "Raise and settle payroll adjustments" },
...
export type Invoice = {
  ...
  /** 0436: the month the period ENDS in. Generated by the database; never written. */
